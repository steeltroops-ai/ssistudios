        ...
        <section className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <h2 className="text-2xl font-bold text-zinc-800">Visiting Card Designs</h2>
                    <p className="text-sm text-zinc-500 mt-1">Explore, customize, and print your next business card.</p>
                </div>
